...
**NOTE: This is a modified version of lol2gltf.**

This modified version is licensed under the GNU General Public License v3.0 or later. See [LICENSE](LICENSE) file for full license text.

- Original work Copyright (C) [Year] Crauzer
- Modifications Copyright (C) 2025 ritoshark

**Modifications made:**
- Added `gltf2static` command (glTF to SCB/SCO conversion)
- Added `gltf2anm` command (glTF to ANM animation extraction)

For detailed information about modifications, see:
- [MODIFICATIONS.txt](MODIFICATIONS.txt)
- [LICENSE_MODIFICATIONS.md](LICENSE_MODIFICATIONS.md)
